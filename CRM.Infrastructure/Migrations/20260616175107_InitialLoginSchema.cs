...
{
    /// <inheritdoc />
    public partial class InitialLoginSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "ActionKey", "Name" },
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0001-000000000001"), "customers.view", "View Customers" },
                    { new Guid("00000000-0000-0000-0001-000000000002"), "customers.edit", "Edit Customers" },
                    { new Guid("00000000-0000-0000-0001-000000000003"), "customers.delete", "Delete Customers" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000002"), "Sales" },
                    { new Guid("00000000-0000-0000-0000-000000000003"), "Viewer" }
                });
