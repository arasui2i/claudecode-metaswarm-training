...
export default function CustomerFormDialog({ open, onClose, onSubmit, defaultValues, title = 'Add Customer' }: Props) {
  const { register, handleSubmit, formState: { errors }, reset } = useForm<CreateCustomerRequest>({
    defaultValues,
  });
